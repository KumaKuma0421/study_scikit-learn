...
columns = ["pattern", "label",
           "precision-0", "precision-1", "precision_sum",
           "recall-0", "recall-1", "recall_sum"]
    ...
    for estimator in common.ESTIMATORS:
        for validator in common.VALIDATORS:
            ...
            if os.path.isfile(file_path):
                ...
                precision0 = data00 + data01
                precision1 = data10 + data11
                recall0 = data00 + data10
                recall1 = data01 + data11
                data["precision-0"] = \
