...
base_path = r"C:\Work\python-3.9.8-embed-amd64\Data\DATA_1_予戦"
point_pattern = [100, 200]
std_pattern = [0]
...
def aggregate_file_1(
    point, std, param, pattern, estimator, validator, extension, target_file
):
    """ファイルを集約していきます。"""
    print(target_file)
...
def search_file(point, std, param, pattern, estimator, validator, extension):
    """ファイル名を構築します。"""
    folder_name = f"DATA_1_{point}_s{std}_p{param}"
