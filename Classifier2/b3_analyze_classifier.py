...
def read_plot_data(idx, estimator_name, validator_name):
    ...
    return x_value, y_value, z1_value, z2_value, z3_value
...
def start_action():
    ...
    for validator in common.VALIDATORS:
        ...
        for pattern, row, estimator in yield_target():
            x_value, y_value, z1_value, z2_value, z3_value = read_plot_data(pattern, estimator, validator)
            axes[row, pattern - 1].contour(x_value, y_value, z1_value, cmap=color_map, alpha=0.8)
            axes[row, pattern - 1].contour(x_value, y_value, z2_value, cmap=color_map, alpha=0.8)
            axes[row, pattern - 1].contour(x_value, y_value, z3_value, cmap=color_map, alpha=0.8)
